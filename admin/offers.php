...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="leftCol">
                ...
                <a href="#" class="d-flex align-items-center text-decoration-none p-1 rounded-3 adminMenuLinks adminMenuLinkSelected"><i class="bi bi-file-earmark-text-fill fs-4 mx-2"></i>
                ...
                <div class="row" style="height: 100%;">
                    ...
                    <div class="col-xl-12 pe-5 px-5" style="height: 85%;">
                        <div class="statsboxPlace p-5" style="display:none;">
                            <a href="#" class="adminAddButton d-flex align-items-center justify-content-center gap-2 text-decoration-none" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-plus-lg fs-2 text-white"></i>
                                <h4 class="m-0 text-white fw-normal">Dodaj</h4>
                            </a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php $parts = explode(":", $row["adress"]);
                                                    $city = end($parts);
                                                    echo $city; ?></td>
                                                <td>
                                                    <i type="button" class="bi bi-three-dots fs-5" data-bs-toggle="dropdown" aria-expanded="false"></i>
                                                    <ul class="dropdown-menu rounded-3">
                                                        <li onclick="GetOfferInfo('<?php echo $offerID; ?>')"><a class="dropdown-item fw-semibold" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-pencil-fill mx-2 me-2"></i>Edytuj</a></li>
                ...
                <div class="modal-content rounded-4" style="height: 80% !important;">
                    ...
                    <div class="modal-body">
                        <form method="post" action="../actions/sendData.php">
                            <input type="hidden" name="offerForm" value="true" id="offerForm">
                                ...
                                <div class="row d-flex justify-content-center">
                                    <div class="col-6">
                                        <div class="form-floating mb-3 mt-3">
                                            ...
                                            <label class="floatingInputStyle">Kategoria</label>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating mb-3 mt-3">
                                            ...
                                            <label class="floatingInputStyle">Firma</label>
                                        </div>
                                        <div class="form-floating mb-3">
    ...
    <script>
        function GetOfferInfo(offerid) {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    document.getElementById('offerForm').value = offerData.offer_id;
                    ...
                    dutiesData.forEach(function(item) {
                        AddExtraInput('duties', 'duties[]', item.duty);
                    });

                    requirementsData.forEach(function(item) {
                        AddExtraInput('requirements', 'requirements[]', item.requirement);
                    });

                    benefitsData.forEach(function(item) {
                        AddExtraInput('benefits', 'benefits[]', item.benefit);
                    });
        ...
        myModal.addEventListener('hidden.bs.modal', function() {
            ...
            if (form) {
                var divsToRemove = form.querySelectorAll('div#duties, div#requirements, div#benefits');
